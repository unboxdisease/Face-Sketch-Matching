...
adaface_models = {
    ...
    'ir_101-GenFaceSketch71' : "experiments/ir101_synthetic_exp1_all_mug_05-09_0/epoch=71-step=117572.ckpt",
    'ir_101-GenFaceSketch65' : "experiments/ir101_synthetic_exp1_all_mug_05-09_0/epoch=65-step=111878.ckpt",
    'ir_101-GenFaceSketch60' : "experiments/ir101_synthetic_exp1_all_mug_05-09_0/epoch=60-step=107133.ckpt",
    'ir_101-GenFaceSketch55' : "experiments/ir101_synthetic_exp1_all_mug_05-09_0/epoch=55-step=102388.ckpt",
    'ir_101-GenFaceSketch50' : "experiments/ir101_synthetic_exp1_all_mug_05-09_0/epoch=50-step=97643.ckpt",
    'ir_101-GenFaceSketch45' : "experiments/ir101_synthetic_exp1_all_mug_05-09_0/epoch=45-step=92898.ckpt",
    'ir_101-GenFaceSketch30' : "experiments/ir101_synthetic_exp1_all_mug_05-09_0/epoch=30-step=78663.ckpt",
...
def main(args):
    ...
    # arc = get_model('r100', fp16=False)
    # arc.load_state_dict(torch.load(weight))
    # arc.eval().to(device)
    ...
    with torch.no_grad():
        ...
        threshold = int(thresholds[optimal_threshold[0]])

        # save_failure_cases(genuine_scores, threshold, save_dir)
        if save_dir is not None:
            ...
            print(genuine_scores[:,2].astype(np.float32), genuine_scores[:,2])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--d", default="/research/prip-jainkush/AdaFace/data_root/real_val", help="Input dir", type=str)
    ...
    parser.add_argument('--save_dir', default='/research/prip-jainkush/AdaFace/experiments/ir101_synthetic_exp1_all_mug_05-09_0/', help='save dir')
