...
def main(args):
    ...
    if args.use_wandb:
        wandb_logger = WandbLogger(save_dir=hparams.output_dir,
                                   name=os.path.basename(args.output_dir), project='adaface_face_real')
    ...
    if not hparams.evaluate:
        # train / val
        # print('loading model')        
        # trainer_mod.laod_from_checkpoint('./pretrained/adaface_ir101_webface4m.ckpt')
