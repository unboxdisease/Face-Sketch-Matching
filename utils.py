...
def get_num_class(hparams):
    ...
    if 'faces_emore' in hparams.train_data_path.lower():
        ...
        assert not hparams.train_data_subset
        class_num = 2059906
    elif '/scratch0/faces_webface_112x112' in hparams.train_data_path.lower():
        class_num = 205990
    elif 'informativeimgs' in hparams.train_data_path.lower():
        class_num = 205990
    elif 'ms1m_orig' in hparams.train_data_path.lower():
        class_num = 205990
    elif 'genfacesketch' in hparams.train_data_path.lower():
        class_num = 205990
    elif 'genfacesketch+real' in hparams.train_data_path.lower():
        class_num = 205990
    elif 'fs-sgc' in hparams.train_data_path.lower():
        class_num = 205990
    elif 'genfacesketch_aligned' in hparams.train_data_path.lower():
        class_num = 205990
    elif 'genfacesketch_aligned_50' in hparams.train_data_path.lower():
        class_num = 205990
    elif 'genfacesketch_aligned_75' in hparams.train_data_path.lower():
        class_num = 205990
    elif 'genfacesketch_aligned_25_4' in hparams.train_data_path.lower():
        class_num = 205990
    elif 'genfacesketch_aligned_50_4' in hparams.train_data_path.lower():
        class_num = 205990
    elif 'genfacesketch_aligned_75_4' in hparams.train_data_path.lower():
        class_num = 205990
    elif 'genfacesketch_aligned_25_3' in hparams.train_data_path.lower():
        class_num = 205990
    elif 'genfacesketch_aligned_50_3' in hparams.train_data_path.lower():
        class_num = 205990
    elif 'genfacesketch_aligned_75_3' in hparams.train_data_path.lower():
        class_num = 205990
